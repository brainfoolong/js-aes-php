export default class JsAesPhp {
   ...
   */
  static async encrypt (value: any, password: string, hashIterations: number = 100000): Promise<string> {
   ...
   * @return {Promise<any>}
   */
  static async decrypt (encryptedValue: string, password: string): Promise<any> {
   ...
   * @private
   */
  private static async generateKey (password: string, salt: Uint8Array, hashIterations: number = 100000): Promise<CryptoKey> {
   ...
   * @return {string}
   */
  private static byteArrayToHex (byteArray: Uint8Array): string {
   ...
   * @return {string}
   */
  private static hexToByteArray (str: string): Uint8Array {
